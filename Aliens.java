...
public class Aliens extends JFrame implements ActionListener {
  ...
  public Aliens(String textForTitleBar) {
    ...
    JPanel p = new JPanel();
      ...
      b.addActionListener(this);
      p.add(b);
      b = new JButton("Rock or Stop");
      b.addActionListener(this);
      p.add(b);
      b = new JButton("Roll or Stop");
      b.addActionListener(this);
      p.add(b);
      b = new JButton("Turn on/off the security");
      b.addActionListener(this);
      p.add(b);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    else if (e.getActionCommand().equalsIgnoreCase("Rock or Stop")) {
      glEventListener.toggleUpdateBranches();
    }
    else if (e.getActionCommand().equalsIgnoreCase("Roll or Stop")) {
      glEventListener.toggleUpdateBranches2();
    }
    else if (e.getActionCommand().equalsIgnoreCase("Turn on/off the security")) {
      glEventListener.toggleLightOn();
    }
